    ...
    methods: {
        ...
        async sendData() {
            try {
                ...
                if (this.editForm.mode == "save") {
                    ...
                    const {
                        data
                    } = await this.$http.post(`api/position`, formData)
                    ...
                    const {
                        data
                    } = await this.$http.post(`api/position/${this.editForm.keydb}`, formData)
        ...
        async delData(index, keyDB) {
            try {
                const {
                    data
                } = await this.$http.delete(`api/position/${keyDB}`)
        ...
        async showDataAll() {
            try {
                const {
                    data
                } = await this.$http.get(`api/position`)
